...
export const createCube = (regl: any) => {
  ...
  return regl({
    ...
    context: {
      ...
      face: (_context: any, { cullFace }: any) => {
        return cullFace === Faces.FRONT ? -1 : 1
      },
      texture: (_context: any, { texture }: any) => {
        return texture || emptyTexture
      },
      reflection: (_context: any, { reflection }: any) => {
        return reflection || emptyCube
      },
      textureMatrix: (_context: any, { textureMatrix }: any) => {
      ...
      scene: () => {
        ...
        return parseFloat(scene as any)
      },
    },
    attributes: {
